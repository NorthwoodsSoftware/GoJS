...
{"from":61, "frompid":"OUT", "to":71}\r
    ...
    myDiagram = new go.Diagram('myDiagramDiv', {\r
      ...
      layout: new go.LayeredDigraphLayout({ direction: 90 }),\r
...
\r
    // when the diagram is vertically oriented, "left" means "top" and "right" means "bottom"\r
    function makePort(name, leftside) {\r
      const port = new go.Shape('Circle', {\r
        fill: '#555555',\r
        stroke: null,\r
...
\r
      const panel = new go.Panel('Vertical', { margin: new go.Margin(0, 2) });\r
\r
      if (leftside) {\r
        port.toSpot = go.Spot.Top;\r
        ...
        port.fromSpot = go.Spot.Bottom;\r
...
\r
    function makeTemplate(typename, icon, background, inports, outports) {\r
      myDiagram.nodeTemplateMap.set(typename, \r
        new go.Node('Spot', { selectionAdorned: false })\r
          .add(\r
            new go.Panel('Auto', { width: 200, height: 90 })\r
              .add(\r
                new go.Shape('RoundedRectangle', {\r
                    fill: go.Brush.lighten(background),\r
                    stroke: 'gray',\r
                    spot1: go.Spot.TopLeft,\r
                    spot2: go.Spot.BottomRight\r
                  })\r
                  .bindObject('fill', 'isSelected', s => s ? 'dodgerblue' : background),\r
                new go.Panel('Table')\r
                  .add(\r
                    ...
                    new go.Picture(icon, { column: 1, width: 55, height: 55 }),\r
                    new go.TextBlock({\r
                        column: 2,\r
                        margin: 3,\r
                        editable: true,\r
            ...
            new go.Panel('Horizontal', {\r
                ...
                alignmentFocus: new go.Spot(0.5, 0, 0, 4)\r
              })\r
              .add(...inports),\r
            new go.Panel('Horizontal', {\r
                alignment: go.Spot.Bottom,\r
                alignmentFocus: new go.Spot(0.5, 1, 0, -4)\r
              })\r
              .add(...outports)\r
          ));\r
    }\r
...
\r
    myDiagram.linkTemplate =\r
      new go.Link({\r
        ...
        .add(\r
          new go.Shape({ stroke: '#555555', strokeWidth: 2 })\r
        );\r
\r
    load();\r
  }\r
...
\r
  ...
  <p>\r
    ...
    <a href="dataFlow">Data Flow (horizontal)</a> sample.\r
  </p>`,descriptionCodeBlocks:[]}),_=a(`<meta name="description"/> <meta property="og:description"/>`,1),v=a(`<meta property="og:title"/> <!>`,1),y=a(`<!> <!>`,1);function b(a,u){c(u,!0);let h=[`tables`,`layered-digraph`,`ports`,`process`];var g=y();l(`1r7c7ez`,e=>{var a=v(),c=o(a),l=n(c,2),p=e=>{var r=_(),i=o(r),a=n(i,2);f(()=>{s(i,`content`,u.data.metadata.description),s(a,`content`,u.data.metadata.description)}),t(e,r)};d(l,e=>{u.data.metadata.description&&e(p)}),f(()=>s(c,`content`,`${u.data.metadata.title??``} | GoJS Diagramming Library`)),i(()=>{r.title=`${u.data.metadata.title??``} | GoJS Diagramming Library`}),t(e,a)});var b=o(g);p(b,{get data(){return u.data}}),m(n(b,2),{get tags(){return h}}),t(a,g),e()}export{b as component,h as universal};