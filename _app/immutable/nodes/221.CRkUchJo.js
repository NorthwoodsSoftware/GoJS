import{$ as e,C as t,G as n,H as r,L as i,T as a,W as o,c as s,et as c,m as l,st as u,x as d,z as f}from"../chunks/BY_RssUb.js";import"../chunks/DTR9fq_7.js";import"../chunks/xihTtKlq.js";import{n as p,t as m}from"../chunks/DzUjTTvJ.js";var h=u({load:()=>g,prerender:()=>!0}),g=()=>({metadata:{title:`Production Process Diagram Editor`,titleShort:`Production Process Editor`,indexDescription:`A designer for creating production process diagrams.`,screenshot:`productioneditor`,priority:1.6,tags:[`geometries`,`svg`,`process`,`palette`,`inspector`,`html`],description:`Oil and gas production diagram editor, for designers.`},htmlContent:`<div style="width: 100%">\r
    <div style="width: 70%; display: inline-block">\r
      <div\r
        id="myPaletteDiv"\r
        style="border: solid 1px black; width: 100%; height: 100px; background: whitesmoke"></div>\r
      <div\r
        id="myDiagramDiv"\r
        style="border: solid 1px black; width: 100%; height: 550px; vertical-align: top"></div>\r
    </div>\r
    <div style="display: inline-block; vertical-align: top; width: 256px"> \r
      <div id="infobox" \r
        style="background: hsl(var(--popover, 60 4.8% 95.9%)); color: hsl(var(--popover-foreground, 20 14.3% 4.1%)); \r
              border: solid 1px hsl(var(--border, 0 0% 83%)); padding: 20px;"\r
      >\r
        <img id="Image" width="216" alt="" src="" />\r
        <h3 id="Title"></h3>\r
        <p id="Description">Select a node to see more information.</p>\r
      </div>\r
      <div id="myInspector" \r
        style="background: hsl(var(--popover, 60 4.8% 95.9%)); color: hsl(var(--popover-foreground, 20 14.3% 4.1%)); \r
              border: solid 1px hsl(var(--border, 0 0% 83%)); padding: .5em; margin-top: 10px; display: none;"\r
      ></div>\r
    </div>\r
  </div>\r
  <div>\r
...
\r
    myDiagram = new go.Diagram('myDiagramDiv', {\r
      ...
      'draggingTool.gridSnapCellSize': new go.Size(10, 1),\r
...
\r
    ...
    load();\r
\r
    // show a collection of node types that the designer may drag into the main diagram\r
    myPalette = new go.Palette('myPaletteDiv', {\r
      layout: new go.GridLayout({ cellSize: new go.Size(1, 1) }),\r
      ...
      model: new go.GraphLinksModel({\r
        nodeDataArray: [\r
          ...
          { icon: 'oil', text: 'Oil\\nCompanies' },\r
          { icon: 'gasprocessing', text: 'Gas Processing' },\r
          { icon: 'fractionation', text: 'Gas Fractionation' },\r
          { icon: 'pyrolysis', text: 'Pyrolysis (Cracking)' },\r
          { icon: 'polymerization', text: 'Basic Polymers' },\r
          { text: 'Intermediates' },\r
          { icon: 'finishedgas', text: 'LPG, Naphtha,\\nMTBE' }\r
        ] // end nodeDataArray\r
      }) // end model\r
    }); // end Palette\r
\r
    // show and let the designer edit some data properties of the selected node or link\r
    myInspector = new Inspector('myInspector', myDiagram, {\r
      properties: {\r
        key: { show: false },\r
        pos: { show: false },\r
        icon: { show: Inspector.showIfNode, type: 'select', choices: IconNames },\r
        color: { type: 'select', choices: ColorNames },\r
        text: { show: Inspector.showIfNode },\r
        caption: { show: Inspector.showIfNode },\r
        imgsrc: { show: Inspector.showIfNode },\r
        from: { show: false },\r
        to: { show: false },\r
        points: { show: false },\r
        fromSpot: { show: Inspector.showIfLink, type: 'select', choices: SpotNames },\r
        toSpot: { show: Inspector.showIfLink, type: 'select', choices: SpotNames }\r
      },\r
      propertyModified: onSelectionChanged\r
    });\r
  }\r
\r
...
\r
  function onSelectionChanged() {\r
    ...
    var inspector = document.getElementById('myInspector');\r
\r
    if (data.imgsrc) {\r
...
\r
    // Show the inspector after the first selection is made\r
    if (inspector.style.display == "none") inspector.style.display = "";\r
  }\r
\r
  window.addEventListener('DOMContentLoaded', init);`,cssCode:`#myInspector {\r
  ...
  #myInspector input,\r
  #myInspector select {\r
    width: 100%;\r
    box-sizing: border-box;\r
  }`,externalStyles:[`https://fonts.googleapis.com/css?family=Lato:400,700`],externalScripts:[`../extensions/DataInspector.js`],descriptionHtml:`<p>\r
    This process flow editor lets the user design diagrams to be shown by\r
    <a href="productionProcess">Production Process</a>.\r
  </p>\r
  <p>\r
    At the top is a <a>Palette</a>, from which the designer can drag-and-drop nodes down into the\r
    main <a>Diagram</a>. When the end-user selects a Node, more information is shown in the gray\r
    area below the diagram. For the designer, the <a>Inspector</a> also shows details about a\r
    selected Node or Link below the diagram, where the designer may modify some of the properties.\r
  </p>\r
  <p>\r
    Each <a>Node</a> consists of an SVG <a>Shape</a> at the top and a rectangular port at the\r
    bottom. The designer can draw new pipes (<a>Link</a>s) by dragging from a port to a different\r
    node's port.\r
  </p>`,descriptionCodeBlocks:[]}),_=a(`<meta name="description"/> <meta property="og:description"/>`,1),v=a(`<meta property="og:title"/> <!>`,1),y=a(`<!> <!>`,1);function b(a,u){c(u,!0);let h=[`geometries`,`svg`,`process`,`palette`,`inspector`,`html`];var g=y();l(`wutixn`,e=>{var a=v(),c=o(a),l=n(c,2),p=e=>{var r=_(),i=o(r),a=n(i,2);f(()=>{s(i,`content`,u.data.metadata.description),s(a,`content`,u.data.metadata.description)}),t(e,r)};d(l,e=>{u.data.metadata.description&&e(p)}),f(()=>s(c,`content`,`${u.data.metadata.title??``} | GoJS Diagramming Library`)),i(()=>{r.title=`${u.data.metadata.title??``} | GoJS Diagramming Library`}),t(e,a)});var b=o(g);p(b,{get data(){return u.data}}),m(n(b,2),{get tags(){return h}}),t(a,g),e()}export{b as component,h as universal};