...
class DragZoomingTool extends go.Tool {
    ...
    set box(val) {
        if (!(val instanceof go.Part))
            throw new Error('DragZoomingTool.box must be a Part');
        this._box = val;
    }
    /**
    ...
    set delay(val) {
        if (typeof val !== 'number')
            throw new Error('DragZoomingTool.delay must be a number');
        this._delay = val;
    }
    /**
