...
class Quadtree {
    ...
    add(obj, x, y, w, h) {
        ...
        if (this._root.bounds !== undefined &&
        ...
        while (!this._root.bounds.containsRect(bounds)) {
            ...
            if ((intersectsTopBound && intersectsRightBound) ||
            ...
            else if ((intersectsBottomBound && intersectsRightBound) ||
