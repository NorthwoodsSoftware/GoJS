 ...
 * The source code for this is at extensionsJSM/DragCreatingTool.ts.
...
export class DragCreatingTool extends go.Tool {
   ...
   * Setting this property does not raise any events.
   */
  get archetypeNodeData(): go.ObjectData | null {
    return this._archetypeNodeData;
  }
  set archetypeNodeData(val: go.ObjectData | null) {
   ...
   */
  insertPart(bounds: go.Rect): go.Part | null {
    const diagram = this.diagram;
