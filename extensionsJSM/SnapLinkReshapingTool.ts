 ...
 * The source code for this is at extensionsJSM/SnapLinkReshapingTool.ts.
...
export class SnapLinkReshapingTool extends go.LinkReshapingTool {
  private _gridCellSize: go.Size;
  private _gridOrigin: go.Point;
  private _isGridSnapEnabled: boolean;
  private _avoidsNodes: boolean;
  // internal state
  private _safePoint: go.Point;
  private _prevSegHoriz: boolean;
  private _nextSegHoriz: boolean;

  constructor(init?: Partial<SnapLinkReshapingTool>) {
    super();
   ...
   */
  override computeReshape(p: go.Point): go.Point {
    let pt = p;
