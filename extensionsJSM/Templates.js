...
export function setupDiagramTemplates(diagram) {
    // Node Templates
...
export function setupDefaultItemTemplate(panel) {
...
export function setupSelectionAdornments(diagram) {
...
export function setupDefaultBackgroundGrid(diagram) {
...
export function setupOverviewBox(overview) {
