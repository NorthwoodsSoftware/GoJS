 ...
 * @category Layout Extension
 */
export var TreeMapOrderedPivot;
 ...
 * @category Layout Extension
 */
export var TreeMapOrderedStoppingLayout;
...
export class TreeMapLayout extends go.Layout {
    ...
    set size(value) {
        ...
        if (((this.isNumeric(value.width) && value.width >= 0) ||
    ...
    layoutOrdered(nodes, total, x, y, w, h, l) {
        ...
        if (nodes.length < 5) {
            ...
            while (L3.length > 0) {
                const node = L3[0];
                if (Math.abs(targetTotal - currentTotal) >
