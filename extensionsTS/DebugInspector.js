(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../release/go", "./ExtendedBrush"], factory);
    }
    ...
    */
    ...
    var ExtendedBrush_1 = require("./ExtendedBrush");
    /*
      DebugInspector code
    ...
    */
    var DebugInspector = (function () {
        function DebugInspector(divid, diagram, options) {
            ...
            this.acceptButton = !!this.options['acceptButton'];
            this.resetButton = !!this.options['resetButton'];
            this.acceptFocus = !!this.options['acceptFocus'];
            this.whenSelected = (this.options['whenSelected'] === undefined) ? true : !!this.options['whenSelected'];
            this.inspectPredicate = this.options['inspectPredicate'] || null;
            this.propertyPredicate = this.options['propertyPredicate'] || null;
            this.propertyNames = this.options['propertyNames'] || null;
            /*
            ...
            */
            ...
            if (this.whenSelected) {
                ...
                diagram.addDiagramListener('ChangedSelection', function (e) {
                    ...
                    if (useLastIndex)
                        chooser.value = self.lastIndex.toString();
        ...
        DebugInspector.prototype.rebuildViews = function () {
            ...
            while (spectrums.length !== 0)
                document.body.removeChild(spectrums[0]);
            var div = this.div;
            ...
            for (var i = 0; i < trackedList.length; i++) {
                ...
                for (var j = 0; j < inspectedProps.length; j++) {
                    ...
                    if (type === "Point" || type === "Size" || type === "Margin" || type === "Rect" || type == "Spot") {
                        ...
                        var input;
                        if (type === "Brush" || type === "boolean")
                            input = group;
                        else
                            input = group.children[1];
                        view.originalValue = input.value;
                    }
                    var val = "";
                    if (coll !== null)
                        val = view.getter(propname);
                    ...
                    if (val === undefined)
                        ...
                        if (view.nullCheckBox)
                            view.nullCheckBox.checked = false;
                    }
                    view.populate(val);
                }
        ...
        DebugInspector.prototype.showObjectProperties = function (obj) {
            ...
            if (this.propertyNames !== null) {
                    ...
                    if (go[k] !== undefined && go[k]['_inspectedProperties'] !== undefined) {
                        ...
                        for (var i = 0; i < props.length; i++) {
                            ...
                            while (options === null && proto && proto.constructor !== Object) {
                                if (proto.constructor._inspectedProperties[prop])
                                    options = proto.constructor._inspectedProperties[prop];
                ...
                for (var _prop in obj) {
                    var options = { setter: View.prototype.defaultDataSetter };
                    if (prop === '__gohashid') {
                        options['type'] = "String";
        ...
        DebugInspector.prototype.createSection = function (name) {
    ...
    */
    var View = (function () {
        ...
        View.prototype.populate = function (val) {
            ...
            switch (type) {
                ...
                case "Brush":
                    ...
                    if (val instanceof go.Brush) {
                        val = ExtendedBrush_1.ExtendedBrush.prototype.stringify(val);
                    }
        ...
        View.prototype.use = function (inspector) {
            ...
            switch (type) {
                ...
                case "Spot":
                    ...
                    if (val === null)
                        val = new go.Spot(obj[0], obj[1], obj[2], obj[3]);
                    break;
                case "Brush":
                    if (this.nullCheckBox.checked) {
                        ...
                        part = part.part;
                        var brush = ExtendedBrush_1.ExtendedBrush.prototype.parse(brushTextField, part.measuredBounds.width, part.measuredBounds.height);
                        val = brush;
                    }
                    break;
                case "boolean":
        ...
        View.prototype.defaultGetter = function (propname) {
            var val = this.object[propname];
            if (val === null)
                return "(null)";
            return val;
        };
        View.prototype.defaultDataGetter = function (propname) {
        ...
        * @param {string} value
        */
        View.prototype.defaultDataSetter = function (diagram, view, propname, value) {
