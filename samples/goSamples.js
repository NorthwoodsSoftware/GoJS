...
function goSamples() {
  ...
  p1.innerHTML = "<a href='https://github.com/NorthwoodsSoftware/GoJS-Samples/blob/master/samples/" + samplename + "' target='_blank'>View this sample page's source on GitHub</a>";
  hdr.appendChild(p1);
